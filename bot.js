...
const replyToTrash = [
  ...
  + "Что, решил ко мне лезть?! Ты, засранец вонючий, мать твою, а? Ну, иди сюда, попробуй меня трахнуть,\n" 
  +  "я тебя сам трахну, ублюдок, онанист чертов, будь ты проклят! Иди, идиот, трахать тебя и всю твою семью,\n" 
  +  "говно собачье, жлоб вонючий, дерьмо, сука, падла! Иди сюда, мерзавец, негодяй, гад, иди сюда, ты, говно, ЖОПА!"
];

const replyToLiberast = [
  ...
  + "Слышь я тебе повторяю ещё раз",
    "Нахуй тебя и нахуй пыню\n"
  + "Со своей послушной толпой\n"
  + "Лучше я сдохну ебучим нонеймом\n"
